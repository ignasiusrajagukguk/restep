...
final List<TierInfo> allTiers = [
  TierInfo(name: 'Starter', subLabel: 'TIER 1 OF 5', range: '0 – 999 pts',
    ...
    perks: [TierPerk(icon: Icons.recycling, title: 'Item tracking', sub: 'Track all recycled items', locked: false), TierPerk(icon: Icons.star_outline, title: 'Base points', sub: '1× on every action', locked: false)]),
  TierInfo(name: 'Explorer', subLabel: 'TIER 2 OF 5', range: '1,000 – 1,999 pts',
    ...
    perks: [TierPerk(icon: Icons.recycling, title: 'Item tracking', sub: 'Track all recycled items', locked: false), TierPerk(icon: Icons.star_outline, title: '1.2× points boost', sub: 'On every recycling action', locked: false), TierPerk(icon: Icons.local_offer_outlined, title: '5% reward discount', sub: 'On all catalog items', locked: false)]),
  TierInfo(name: 'Guardian', subLabel: 'TIER 3 OF 5', range: '2,000 – 4,999 pts',
    ...
    perks: [TierPerk(icon: Icons.recycling, title: 'Priority recycling', sub: 'Skip the standard queue', locked: false), TierPerk(icon: Icons.star_outline, title: '1.5× points boost', sub: 'On every recycling action', locked: false), TierPerk(icon: Icons.local_offer_outlined, title: '10% reward discount', sub: 'On all catalog items', locked: false), TierPerk(icon: Icons.bolt_outlined, title: 'Early access deals', sub: 'Special offers before others', locked: false)]),
