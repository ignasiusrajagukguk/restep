...
// SCREEN
// ─────────────────────────────────────────────────────────────────────────────
class ConfirmPromoRedemptionScreen extends StatefulWidget {
  const ConfirmPromoRedemptionScreen({super.key});

  @override
  State<ConfirmPromoRedemptionScreen> createState() =>
      _ConfirmPromoRedemptionScreenState();
}

class _ConfirmPromoRedemptionScreenState
    extends State<ConfirmPromoRedemptionScreen> {
  int image = 0;
...
class _ProductDetailWidgetState extends State<ProductDetailWidget> {
  ...
  String _selectedTime = '17.00 - 17.15';
  ...
  final List<_Review> _reviews = [
    ...
    _Review(
      name: 'Christina',
      text: 'Love the concept of not wasting food.',
      rating: 5,
      timeAgo: '3 weeks ago',
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Last Chance Bakery – Verspillen? Liever Niet!',
            style: TextStyle(
              fontSize: 20,
              fontWeight: FontWeight.w700,
              color: valueColor,
          ...
          const Text(
            'Freshly baked goods from yesterday, still soft and tasty.',
  ...
  Widget _buildDetailsContent() {
    return Column(
      ...
      children: [
        // Select Colors
        _sectionLabel('What’s Inside Today'),
        ...
        RadioGroup<int>(
          ...
          child: Column(
            children: List.generate(_colors.length, (i) {
              return Row(
                children: [
                  Radio<int>(value: i, activeColor: ConstColors.blue,),
                  Text(_colors[i]),
                ],
              );
            }),
        ...
        // Select Pickup Locations
        _sectionLabel('Select Pickup Time'),
        const SizedBox(height: 12),
        _timeDropdown(),
...
Widget _buildSpecialDealsSection() {
  final List<_DealItem> deals = [
    _DealItem(
      name: 'Save Me Box – Wij Gooien Liever Niets Weg',
      pts: 80,
      originalPts: 100,
      discount: '-20%',
      imageUrl:
    ...
    _DealItem(
      name: 'Perfectly Imperfect Veggies – Save & Enjoy',
      pts: 80,
      originalPts: 100,
      discount: '-20%',
      imageUrl:
