...
import 'package:restep/presentation/screens/store_details/full_map.dart';
...
class _StoreDetailsScreenState extends State<StoreDetailsScreen> {
  ...
  /// Store location — single source of truth shared with FullMapScreen
  static const LatLng _storeLocation = LatLng(52.3676, 4.8945);
  static const String _storeName = 'PLUS Amsterdam';
  static const String _storeAddress = 'Kinkerstraat 120, Amsterdam';
                  ...
                  child: Center(
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Image.asset(IconsAsset.point, height: 15),
                ...
                background: Stack(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(color: Color(0xFFCCD9CC)),
                      child: ClipRRect(
                        child: Image.asset(
                          ImageAsset.store,
                          fit: BoxFit.cover,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Image.asset(IconsAsset.plus, height: 18),
                        ),
                        const Text(
                          'PLUS Amsterdam',
                          style: TextStyle(
                    ...
                    const SizedBox(height: 20),
                    const Divider(color: Color(0xFFDDE8DD), thickness: 1),
                      ...
                      child: SizedBox(
                        ...
                        child: FlutterMap(
                          options: MapOptions(
                            ...
                            initialZoom: 15,
                            // Disable interactions on the mini map so scroll
                            // passes through to the parent scroll view
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) => _ProductCard(
                        ...
                        onBuyWithMoney: () => _onBuyWithMoney(_products[index]),
                        onRedeemWithPoints: () =>
